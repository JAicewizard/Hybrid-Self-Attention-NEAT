...
class DefaultStagnation(DefaultClassConfig):
    ...
    def update(self, species_set, generation):
        ...
        and - unless it would result_org in the number of species dropping below the configured
        ...
        for idx, (sid, s) in enumerate(species_data):
            ...
            # result_org in the total number of species dropping below the limit.
