...
2. Load configs and create a population - here, the variable ``p``.
...
class DistributedEvaluator(object):
    ...
    def __init__(
        ...
        getting the attention_hyper_neat_results from a worker subprocess; if None, there is no timeout.
